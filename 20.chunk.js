...
var DeleteProductComponent = (function () {
    function DeleteProductComponent(_GetProductService, _productDeleteService, _getChemistDataService, router) {
        var _this = this;
    ...
    DeleteProductComponent.prototype.getProductId = function (ProductId) {
        ...
        this.AddCategoryServiceArray = [];
        this._productDeleteService.ProductDeleteCServices(ProductId).subscribe(function (response) {
            console.log(response.data);
        });
    };
    ...
    DeleteProductComponent = __decorate([
        core_1.Component({
            ...
            providers: [GetAllProductService_1.GetAllProductService, ProductDeleteService_1.ProductDeleteService, GetCategoryAndSubcategoryService_1.GetCategoryAndSubcategoryService],
        ...
        __metadata('design:paramtypes', [(typeof (_a = typeof GetAllProductService_1.GetAllProductService !== 'undefined' && GetAllProductService_1.GetAllProductService) === 'function' && _a) || Object, (typeof (_b = typeof ProductDeleteService_1.ProductDeleteService !== 'undefined' && ProductDeleteService_1.ProductDeleteService) === 'function' && _b) || Object, (typeof (_c = typeof GetCategoryAndSubcategoryService_1.GetCategoryAndSubcategoryService !== 'undefined' && GetCategoryAndSubcategoryService_1.GetCategoryAndSubcategoryService) === 'function' && _c) || Object, (typeof (_d = typeof router_1.Router !== 'undefined' && router_1.Router) === 'function' && _d) || Object])
