...
var routes = [
    { path: '', component: layout_component_1.Layout, children: [
            ...
            { path: 'DeleteProduct', loadChildren: function () { return __webpack_require__.e/* System.import */(20).then(__webpack_require__.bind(null, "./src/app/DeleteProduct/DeleteProduct.module.ts")).then(function (mod) { return (mod.__esModule && mod.default) ? mod.default : mod; }); } },
            ...
            { path: 'PendingOrder', loadChildren: function () { return __webpack_require__.e/* System.import */(18).then(__webpack_require__.bind(null, "./src/app/PendingOrder/PendingOrder.module.ts")).then(function (mod) { return (mod.__esModule && mod.default) ? mod.default : mod; }); } },
