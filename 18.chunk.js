...
var GetProductComponent = (function () {
    function GetProductComponent(_GetProductService, router, _addDosageService) {
        var _this = this;
    ...
    GetProductComponent = __decorate([
        core_1.Component({
            selector: 'GetProduct',
            providers: [AddMedicineService_1.AddMedicineService, AdddosageService_1.AddDosageService, GetAllProductService_1.GetAllProductService],
