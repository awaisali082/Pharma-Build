        ...
        this._addMedicineService.GetOrderDetailService().subscribe(function (response) {
            ...
            for (var i = 0; i < response.data.length; i++) {
                if (_this.GetOrderDetailModelArray[i].OrderStatus == 100) {
                    _this.GetOrderDetailModelArray[i].OrderStatus = OrderNumber.PENDING;
                }
                else if (_this.GetOrderDetailModelArray[i].OrderStatus == 200) {
                    _this.GetOrderDetailModelArray[i].OrderStatus = OrderNumber.ONTHEWAY;
                }
                else if (_this.GetOrderDetailModelArray[i].OrderStatus == 300) {
                    _this.GetOrderDetailModelArray[i].OrderStatus = OrderNumber.DELIVERED;
                }
                else if (_this.GetOrderDetailModelArray[i].OrderStatus == 400) {
                    _this.GetOrderDetailModelArray[i].OrderStatus = OrderNumber.CONFIRMED;
                }
                else if (_this.GetOrderDetailModelArray[i].OrderStatus == 500) {
                    _this.GetOrderDetailModelArray[i].OrderStatus = OrderNumber.SHIPPED;
                }
                else if (_this.GetOrderDetailModelArray[i].OrderStatus == 600) {
                    _this.GetOrderDetailModelArray[i].OrderStatus = OrderNumber.NOTSHIPPED;
                }
                else if (_this.GetOrderDetailModelArray[i].OrderStatus == 700) {
                    _this.GetOrderDetailModelArray[i].OrderStatus = OrderNumber.CANCELED;
                }
                else if (_this.GetOrderDetailModelArray[i].OrderStatus == 800) {
                    _this.GetOrderDetailModelArray[i].OrderStatus = OrderNumber.COMPLETED;
                }
                else if (_this.GetOrderDetailModelArray[i].OrderStatus == 900) {
                    _this.GetOrderDetailModelArray[i].OrderStatus = OrderNumber.RETURNED;
                }
                else if (_this.GetOrderDetailModelArray[i].OrderStatus == 10) {
                    _this.GetOrderDetailModelArray[i].OrderStatus = OrderNumber.TOBEDELIVERED;
                }
                else {
                    alert("Not Available");
                }
