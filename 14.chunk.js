...
var MedicineComponent = (function () {
    ...
    MedicineComponent.prototype.populatePricePerQuantity = function () {
        ...
        this.SinglePricePerQuantityModel.MeasurementId =
        ...
        console.log(this.PricePerQuantityModelSingle);
        jQuery("#snackbar").html("Measurement Add Successfully");
        this.myFunction();
    };
    ...
    MedicineComponent.prototype.SelectMeasurement = function () {
        var _this = this;
        this.SelectedMeasurementModel.push(this.MedicineMeasurementName);
        this.tempObj = this.MeasurementModel.find(function (x) { return x.Id == _this.MedicineMeasurementName; });
